...
class SpherePointNetRingAttentionAndConvolution2(nn.Module):
    def __init__(self, ring=3, input_channels=4):
        ...
        self.attn_block2 = TransformerEncoderBlock3(input_dim=16, embed_dim=64)
        self.attn_blobk2x = TransformerEncoderBlock3(input_dim=16, embed_dim=64)
        self.attn_block2y = TransformerEncoderBlock3(input_dim=16, embed_dim=64)
        self.attn_blobk2z = TransformerEncoderBlock3(input_dim=16, embed_dim=64)
        self.conv3 = nn.Conv1d(16, 64, 1)
        self.attn_block4 = TransformerEncoderBlock3(input_dim=64, embed_dim=256)
        self.attn_blobk4x = TransformerEncoderBlock3(input_dim=64, embed_dim=256)
        self.attn_block4y = TransformerEncoderBlock3(input_dim=64, embed_dim=256)
        self.attn_blobk4z = TransformerEncoderBlock3(input_dim=64, embed_dim=256)
